...
<template>
  <footer class="footer-distributed">
    ...
    <div class="footer-right">
      <a href="https://www.linkedin.com/in/abdulqader-haritani-763a67199/" target="_blank"><i class="fa fa-linkedin"></i></a>
      <a href="https://github.com/ix3bd2" target="_blank"><i class="fa fa-github"></i></a>
    </div>
