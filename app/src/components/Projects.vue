  ...
  <section id="works" class="s-works target-section">
    ...
    <div class="masonry-wrap">
      <div class="masonry">
        ...
        <div class="masonry__brick " data-aos="fade-up">
          ...
          <img class="used-lang-vue" src="../assets/vue-logo.png" />
            ...
            <div class="item-folio__text">
              <h4 class="item-folio__title">Genshin Impact</h4>
              <p class="item-folio__cat">World Records</p>
            </div>
        ...
        <div class="masonry__brick main__brick" data-aos="fade-up" >
          <div class="item-folio">
            <div class="item-folio__thumb">
              <a
            ...
            <div class="item-folio__text">
              ...
              <p class="item-folio__cat">white-label Portal</p>
            </div>
            <div class="item-folio__caption">
              <p>
                Vero molestiae sed aut natus excepturi. Et tempora numquam.
